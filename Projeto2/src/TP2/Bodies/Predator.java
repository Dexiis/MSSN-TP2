...
public class Predator extends Boid {
	...
	public Predator(PVector pos, float mass, float radius, int color, PApplet p, SubPlot plt, List<Body> allTrackingBodies) {
		super(pos, mass, radius, color, Entity.PREDATOR, p, plt);
